...
#pragma warning restore IDE0065
  ...
  public class LineAnnotation : HierarchicalAnnotation
  {
    ...
    public void Draw(GameObject a, GameObject b, string tagName = "")
    {
      _lineRenderer.SetPositions(new Vector3[] { a.transform.localPosition, b.transform.localPosition });
      if (tagName == "" || tagName is null)
        return;
      var skeletonPart = GameObject.FindGameObjectWithTag(tagName);
      if (skeletonPart is null)
        return;
      
      skeletonPart.transform.SetPositionAndRotation(a.transform.position, a.transform.rotation);
    }
