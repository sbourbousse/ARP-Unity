...
#pragma warning restore IDE0065
  ...
  public class PointAnnotation : HierarchicalAnnotation
  {
    ...
    protected PoseLandmarkListAnnotation.PoseLandMarkModelPoint poseLandMarkModelPoint;
    ...
    public void SetPoseLandMarkModelPoint(PoseLandmarkListAnnotation.PoseLandMarkModelPoint point)
    {
      poseLandMarkModelPoint = point;
    }
    ...
    {
      transform.localScale = 3.0f * Vector3.one;
    }
